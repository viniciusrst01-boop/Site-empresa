(() => {
  ...
  function addStyles() {
    ...
    style.textContent += `.qualitypro-doughnut-plot{align-self:center;justify-self:center;width:min(100%,190px);height:min(100%,190px);aspect-ratio:1/1}.qualitypro-doughnut-plot>canvas{aspect-ratio:1/1}@container (max-width:360px){.qualitypro-doughnut-plot{width:min(100%,165px);height:min(100%,165px)}}`;
